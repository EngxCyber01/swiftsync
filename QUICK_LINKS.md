...
**Database**: 51 lectures with preserved dates  
**Security**: 7-layer detection active  
...
- 6 detection rule cards
- Threat logs
- Visitor analytics
- Block/whitelist controls
- Professional Kurdish SOC interface
...
- [  ] Copy public URL from Render
- [  ] Share via WhatsApp/Telegram
- [  ] Show them PWA installation
- [  ] Demonstrate AI summary feature
...
- **PWA installable** on phones and computers
...
- Use university credentials for attendance
- Safe to share public URL widely
...
- [ADMIN_SOC_GUIDE.md](ADMIN_SOC_GUIDE.md) - SOC dashboard tutorial
...
- **Security Patterns**: 100+ threat signatures
- **Features**: 15+ major features
- **Database**: 51 lectures migrated
- **Subjects**: 8 subjects organized
