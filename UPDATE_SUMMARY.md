...
- Professional dark theme with Kurdish yellow accent
- "Refresh Rules" now refreshes the page instead of alert
...
2. **Admin Portal:**
   ...
   - 6 security rule cards (all ENABLED)
   - Custom notification system (no alerts)
   - Threat detection logs table
   - Live monitoring badges

3. **Security in Action:**
   - Malicious requests automatically blocked
   - Threat logs recorded in real-time
   - IP auto-blocking on detection
   - Custom security alert page
